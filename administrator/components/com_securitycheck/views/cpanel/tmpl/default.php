...
<div class="securitycheck-bootstrap">
	...
	<div class="row-fluid">
		...
		<div id="cpanel" class="box-content">
			<fieldset>
			<legend><?php echo JText::_('COM_SECURITYCHECK_CPANEL_OPTIONS'); ?></legend>
			<div class="icon">
				<a href="<?php echo JRoute::_( 'index.php?option=com_securitycheck&controller=securitycheck&'. JUtility::getToken() .'=1' );?>">
			...
			<div class="icon">
				<a href="<?php echo JRoute::_( 'index.php?option=com_securitycheck&controller=filemanager&view=filemanager&'. JUtility::getToken() .'=1' );?>">
			...
			<div class="icon">
				<a href="<?php echo JRoute::_( 'index.php?option=com_securitycheck&controller=protection&view=protection&'. JUtility::getToken() .'=1' );?>">
		...
		<fieldset>
			...
			<div class="icon">
				<a href="index.php?option=com_config&view=component&component=com_securitycheck&path=&tmpl=component"
				 class="modal" rel="{handler: 'iframe', size: {x: 660, y: 500}}">
			...
			<div class="icon">
				<a href="<?php echo JRoute::_( 'index.php?option=com_securitycheck&controller=filemanager&view=sysinfo&'. JUtility::getToken() .'=1' );
	?>">
		...
		<fieldset>
			...
			<div class="icon">
				<a href="<?php echo 'index.php?option=com_securitycheck&controller=filemanager&view=initialize_data&'. JUtility::getToken() .'=1'?>">
