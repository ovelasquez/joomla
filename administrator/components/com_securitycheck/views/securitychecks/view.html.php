...
*
*/
class SecuritychecksViewSecuritychecks extends JView
{
/**
...
$document->addStyleDeclaration('.icon-32-buscar {background-image: url(../media/com_securitycheck/images/lists.png);}');
$document->addStyleDeclaration('.icon-32-view_logs {background-image: url(../media/com_securitycheck/images/logs.png);}');
