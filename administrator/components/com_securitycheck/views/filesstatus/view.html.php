...
*
*/
class SecuritychecksViewFilesStatus extends JView{
...
JToolBarHelper::custom('redireccion_file_manager_control_panel','back','back','COM_SECURITYCHECK_REDIRECT_FILE_MANAGER_CONTROL_PANEL');
