...
*/
class SecuritychecksModelProtection extends JModel
{
...
/* Guarda la configuración de 'htaccess protection' en la tabla #__securitycheck_storage */
...
public function protect()
{
	...
	if ( !is_null($this->getValue("hide_backend_url")) ) {
		if ( ( !$ExistsHtaccess ) || (( $ExistsHtaccess ) &&  ( !$this->ConfigApplied['hide_backend_url'] )) ) {
			$rules .= PHP_EOL . "## Begin Securitycheck Hide Backend Url";
			...
			$rules .= PHP_EOL . "## End Securitycheck Hide Backend Url";
		}
	}
