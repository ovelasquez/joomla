...
/**
* Securitychecks  Controller
*
*/
class SecuritychecksControllerProtection extends JController
{
/**
...
{
	$this->setRedirect( 'index.php?option=com_securitycheck&controller=securitycheckpro' );
}
...
public function save()
{
	...
	$this->setRedirect('index.php?option=com_securitycheck&view=cpanel&'. JUtility::getToken() .'=1',JText::_('COM_SECURITYCHECK_CONFIGSAVED'));
}
...
{
	$this->save();
	$this->setRedirect('index.php?option=com_securitycheck&controller=protection&view=protection&'. JUtility::getToken() .'=1',JText::_('COM_SECURITYCHECK_CONFIGSAVED'));
}
...
function protect()
{
	...
	$url = 'index.php?option=com_securitycheck&controller=protection&view=protection&'. JUtility::getToken() .'=1';
	if($status) {
