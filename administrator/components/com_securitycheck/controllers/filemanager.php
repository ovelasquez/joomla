 ...
 *
 */
class SecuritychecksControllerFileManager extends JController
{
...
function redireccion_control_panel_y_borra_log()
{
	...
	$filename = $logName . DS ."change_permissions.log.php";
	...
	$this->setRedirect( 'index.php?option=com_securitycheck&controller=filemanager&view=filemanager&'. JUtility::getToken() .'=1' );
}
